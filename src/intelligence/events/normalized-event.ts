...
export interface NormalizedEvent<T = Record<string, unknown>> {
  ...
  readonly lifecycle: readonly EventLifecycleStage[];
  readonly payload: T;
}
...
export interface TelemetryRoutingPolicy {
  includeTiers?: TelemetryTier[];
  excludeEventTypes?: IntelEventType[];
